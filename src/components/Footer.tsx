...
const Footer = () => {
  ...
  const FooterLinkedInIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"
         className="text-slate-500 dark:text-slate-400 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-300">
  ...
  const FooterEmailIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"
         className="text-slate-500 dark:text-slate-400 group-hover:text-red-500 dark:group-hover:text-red-400 transition-colors duration-300">
      <path d="M0 3v18h24v-18h-24zm21.518 2l-9.518 7.713-9.518-7.713h19.036zm-19.518 14v-11.817l10 8.104 10-8.104v11.817h-20z"/>
    </svg>
  );

  const socialLinks = [
    { name: 'GitHub', href: user.github, IconComponent: FooterGitHubIcon },
    { name: 'LinkedIn', href: user.linkedin, IconComponent: FooterLinkedInIcon },
    { name: 'Email', href: `mailto:${user.email}`, IconComponent: FooterEmailIcon }
  ];
