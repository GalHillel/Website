...
export default function ContactSection({ user, resumeUrl, uiContent, sectionTitle }: ContactFormProps) {
    ...
    return (
        <section id="contact" className="container mx-auto px-4 py-24 md:py-32">
            <ScrollReveal width="100%">
                <SectionTitle
                    title={sectionTitle || uiContent?.title || "GET IN TOUCH"}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-start max-w-6xl mx-auto">
                ...
                <ScrollReveal delay={0.4} width="100%" className="space-y-6">
                    <SpotlightCard className="p-6 sm:p-8 backdrop-blur-xl bg-[#0f1020]/80 border-white/10 shadow-2xl relative overflow-hidden group">
                        {/* Subtle Inner Glow */}
